...
const Modal = (props) => {
  ...
  return (
    <CSSTransition in={props.show} timeout={duration} onEnter={() => props.setShowTrigger(false)} onExit={() => props.setShowTrigger(true)} classNames='modal' mountOnEnter unmountOnExit>
